...
/**
 * Test case for class \Lobacher\Simpleblog\Domain\Model\Comment.
 *
...
class CommentTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	/**
	 * @var \Lobacher\Simpleblog\Domain\Model\Comment
	 */
	protected $subject = NULL;

	public function setUp() {
		$this->subject = new \Lobacher\Simpleblog\Domain\Model\Comment();
	}
