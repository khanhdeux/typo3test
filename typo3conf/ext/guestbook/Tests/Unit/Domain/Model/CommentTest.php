...
/**
 * Test case for class \Vendor\Guestbook\Domain\Model\Comment.
 *
...
class CommentTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	/**
	 * @var \Vendor\Guestbook\Domain\Model\Comment
	 */
	protected $subject = NULL;

	public function setUp() {
		$this->subject = new \Vendor\Guestbook\Domain\Model\Comment();
	}
