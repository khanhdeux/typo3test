...
/*
    ...
    class FPDF
          ...
          |_____________
                        |
                        |
    class FPDF_TPL extends FPDF   // importing templates
          |
          |_____________
                        |
                        |
    class FPDI extends FPDF_TPL
          ...
          |_____________
                        |
                        |
    class XPDF extends FPDI  // Tagbased Stylesheets
          |
          |_____________
                        |
                        |
    class UFPDF extends XPDF  // UTF-8 Support
...
function _puttruetypeunicode($font) {
  ...
  $this->_newobj();
  if(defined('MAKEPDF_FONTPATH'))
    $file=MAKEPDF_FONTPATH.$font['ctg'];
  else
    $file=$font['ctg'];
  $size=filesize($file);
  if(!$size)
