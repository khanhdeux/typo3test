...
function GetStringWidth($s)
{
	...
	$debug = Array(
	        //"cw" => $cw, 
	        "s" => $s, 
	        "stringwidth" => $w*$this->FontSize/1000,
	);
	//t3lib_div::devLog('Debug GetStringWidth','csg_reiseangebote', 3, $debug);
...
function Cell($w, $h=0, $txt='', $border=0, $ln=0, $align='', $fill=false, $link='')
{
	...
	if($txt!=='')
	{
		//$txt = utf8_decode($txt); //28.9.09 CSG
		//echo($txt);
		if($align=='R')
...
{
	if(!defined('MAKEPDF_FONTPATH') && is_dir(dirname(__FILE__).'/font'))
		define('MAKEPDF_FONTPATH',dirname(__FILE__).'/font/');
	return defined('MAKEPDF_FONTPATH') ? MAKEPDF_FONTPATH : '';
}
