<?php
namespace Lobcher\Simpleblog\Domain\Repository;
...
class BlogRepository extends \TYPO3\CMS\Extbase\Persistence\Repository {
	...
	public function findSearchForm($search, $limit
		...
		$query->matching($query->like('titlle', '%' . $search . '%'));
		$query->setOrderings(array('titlle' => \TYPO3\CMS\Extbase\Persistence\QueryInterface::ORDER_ASCENDING));
		$limit = (int) $limit;
		if ($limit > 0) {
