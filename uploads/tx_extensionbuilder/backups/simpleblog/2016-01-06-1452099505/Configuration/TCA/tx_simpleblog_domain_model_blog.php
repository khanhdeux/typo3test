...
return array(
	'ctrl' => array(
		...
		'searchFields' => 'titlle,description,image,posts,',
		'iconfile' => \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extRelPath('simpleblog') . 'Resources/Public/Icons/tx_simpleblog_domain_model_blog.gif'
	),
	'interface' => array(
		'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, titlle, description, image, posts',
	),
	'types' => array(
		'1' => array('showitem' => 'sys_language_uid;;;;1-1-1, l10n_parent, l10n_diffsource, hidden;;1, titlle, description, image, posts, --div--;LLL:EXT:cms/locallang_ttc.xlf:tabs.access, starttime, endtime'),
	),
	'palettes' => array(
		'1' => array('showitem' => ''),
	),
	'columns' => array(
		...
		'titlle' => array(
			'exclude' => 0,
			'label' => 'LLL:EXT:simpleblog/Resources/Private/Language/locallang_db.xlf:tx_simpleblog_domain_model_blog.titlle',
			'config' => array(
				'type' => 'input',
				'size' => 30,
				'eval' => 'trim,required'
