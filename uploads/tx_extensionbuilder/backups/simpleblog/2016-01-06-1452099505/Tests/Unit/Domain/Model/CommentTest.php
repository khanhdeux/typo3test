...
/**
 * Test case for class \Lobcher\Simpleblog\Domain\Model\Comment.
 *
...
class CommentTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	/**
	 * @var \Lobcher\Simpleblog\Domain\Model\Comment
	 */
	protected $subject = NULL;

	public function setUp() {
		$this->subject = new \Lobcher\Simpleblog\Domain\Model\Comment();
	}
